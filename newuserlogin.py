...
l0=Label(root,text="New User Login Screen",fg="",bg="",font=("Algerian",50,"bold","italic","underline"))
l1=Label(root,text="Enter Name",fg="",bg="",font=("Monotype Corsiva",40,"bold"))
l2=Label(root,text="Enter Phone Number",fg="",bg="",font=("Monotype Corsiva",40,"bold"))
l3=Label(root,text="Enter Username",fg="",bg="",font=("Monotype Corsiva",40,"bold"))
l4=Label(root,text="Enter Password",fg="",bg="",font=("Monotype Corsiva",40,"bold"))

t1=Entry(root,textvariable=txtname,fg="",bg="",font=("Monotype Corsiva",40,"bold"))
t2=Entry(root,textvariable=txtphoneno,fg="",bg="",font=("Monotype Corsiva",40,"bold"))
t3=Entry(root,textvariable=txtusername,fg="",bg="",font=("Monotype Corsiva",40,"bold"))
t4=Entry(root,textvariable=txtpassword,show="*",fg="",bg="",font=("Monotype Corsiva",40,"bold"))
